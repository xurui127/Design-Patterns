...
namespace Menu
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MenuComponent cafeMenu = new Menus("Cafe Menu", "Diner");
            MenuComponent dessertMenu = new Menus("Dessert Menu", "Dessert");
           ...
           dinerMenu.Add(new MenuItem("Vegetarian BLT", "(Fakin') Bacon with lettuce & tomato on whole wheat", true, 2.99));
            ...
            dessertMenu.Add(new MenuItem("Chessecake","Creamy New York cheesecake, with a chocolate graham crust",true,1.99));
            dessertMenu.Add(new MenuItem("Sorbet","A scoop of raspberry and a scoop of lime",true,1.89));

            cafeMenu.Add(new MenuItem("Veggie Burger and Air Fries", "Veggie burger on a whole wheat bun, lettuce, tomato, and fries", true, 3.99));
            cafeMenu.Add(new MenuItem("Soup of day", "A cup of the soup of the day, with a side salad", false, 3.69));
            cafeMenu.Add(new MenuItem("Burrito", "A large burrito, with whole pinto beans, salad, guacamole", true, 4.29));
